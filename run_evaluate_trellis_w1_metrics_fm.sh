...
#SBATCH --mem 32GB
#SBATCH -o logs/oval_drugclass_fm_%a
#SBATCH -e logs/eval_drugclass_fm_%a
#SBATCH --array=0-14:1
...
# Alternate experiment / output roots (uncomment and adjust if needed):
#   --match experiment.name=trellis_a2a_fm_ctt
