...
def find_experiment_dir(
    ...
    Args:
        ...
        num_epochs: The number of training epochs (training.num_epochs)
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of training epochs to search for (training.num_epochs). "
             "Only used if provided."
    )
    parser.add_argument(
        "--outputs_dir",
    ...
    if args.experiment_dir is None:
        ...
        if not has_filter:
            parser.error("Must provide either --experiment_dir or at least one filter criterion "
                        "(--split_name, --predictor_loss_weight, --seed, --selective_pairing_mode, --experiment_name, --num_epochs)")
