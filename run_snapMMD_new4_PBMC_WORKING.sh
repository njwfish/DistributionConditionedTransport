...
#SBATCH --mem 10GB
#SBATCH -o logs/o011_%a
#SBATCH -e logs/e011_%a
#SBATCH --array=0-99:1
...
python main.py experiment=snapMMD_energy_reg dataset_name=${dataset_name} experiment.predictor_loss_weight=${alpha} experiment.weight_mode=${weight_mode} experiment.selective_pairing_mode=${selective_pairing_mode} seed=${seed} experiment.ot_coupling=${ot_coupling}
