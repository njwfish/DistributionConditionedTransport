...
def main():
    ...
    parser.add_argument("--data_out", default="data/spikeprot0430/virus_tokenized_data_for_tde_downsampled100_filtered.pt", help="Path to save filtered dataset .pt (default: <data_in>.filtered.pt)")
    ...
    for el in data:
        ...
        idx = keep_mask.nonzero(as_tuple=False).view(-1).tolist()
        el["raw_texts"] = [el["raw_texts"][i] for i in idx]
