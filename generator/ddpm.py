...
class DDPM(nn.Module):
    ...
    def forward(self, x_source, x_target, c_source, c_target):
        """
    ...
    def loss(self, x_source, x_target, c_source, c_target):
        return self.forward(x_source, x_target, c_source, c_target)
