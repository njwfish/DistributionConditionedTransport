...
class SDE_LV(Dataset):
    """Unified dataset for all SnapMMD datasets (GoM, LV, PBMC, Repressilator)."""
    
    # Dataset-specific configurations
    DATASET_CONFIGS = {
        # TODO: avoid hard-coding the data name.
        'LV': {
            'data_dir': 'data/classic',
            #'data_name': 'LV_simulated_dataset_1000_31_seed0.npz',
            'data_name': 'LV_simulated_dataset_1000_11_seed0.npz',
            'data_shape': [2],
            'has_x_scaling': False
        },
