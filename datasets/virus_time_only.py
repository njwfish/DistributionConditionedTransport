...
class ViralDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        location_idx_target = np.random.choice(len(self.data[target_idx]))
        ...
        date_source, location_source = self._parse_time_loc(time_loc_source)
        date_target, location_target = self._parse_time_loc(time_loc_target)
