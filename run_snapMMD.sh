...
dataset_idx=$((SLURM_ARRAY_TASK_ID / (num_weight_modes * num_selective_pairing_modes * num_seeds)))
weight_mode_idx=$(((SLURM_ARRAY_TASK_ID % (num_weight_modes * num_selective_pairing_modes * num_seeds)) / (num_selective_pairing_modes * num_seeds)))
selective_pairing_mode_idx=$(((SLURM_ARRAY_TASK_ID % (num_selective_pairing_modes * num_seeds)) / num_seeds))
...
python main.py experiment=snapMMD_mfm dataset_name=${dataset_name} experiment.weight_mode=${weight_mode} experiment.selective_pairing_mode=${selective_pairing_mode} seed=${seed} experiment.ot_coupling=${ot_coupling}
